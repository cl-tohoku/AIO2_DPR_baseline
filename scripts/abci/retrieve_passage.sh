#!/bin/bash
# qsub -cwd -g gcb50246 -l rt_G.large=1 -l h_rt=5:00:00 -N log_retrieve -j y $HOME/exp2021/DPR_baseline/scripts/abci/retrieve_passage.sh
...
embed=/groups/1/gcb50246/migrated_from_SFA_GPFS/miyawaki/DPR_baseline/baseline/embeddings/emb_dpr_biencoder.59.230.pickle
